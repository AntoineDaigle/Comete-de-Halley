...
if __name__ == "__main__":
    ...
    t1 = time.time()
    t, x_and_v_points, h = runge_kutta(0, 1e10, 1E05, cond_init, masses, 1E-07).simulation()
    t2 = time.time()
    ...
    t1 = time.time()
    t_non_perturb, x_and_v_points_non_perturb, h_non_perturb = runge_kutta(0, 2e09, 1E05, cond_init, masses_non_perturb, 1E-07).simulation()
    t2 = time.time()
    ...
    ax.set_aspect("equal")
    time_text = plt.text(0,12, "Temps : 0 années")
