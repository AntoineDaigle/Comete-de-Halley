...
if __name__ == "__main__":
    ...
    # masses = np.array([[2.2E14, 0, 5.683E26]])
    masses = np.array([[2.2E14, 1.898E27, 5.683E26]])
    
    t1 = time.time()
    t, x_and_v_points, h = runge_kutta(0, 2e09, 1E05, cond_init, masses, 1E-07).simulation()
    t2 = time.time()
